...
# ─────────────────────────────────────────────────────────────
#  行业种子问题库（用户真实会问 AI 的问题）
#  可通过环境变量 GEO_SEED_QUESTIONS_JSON 指向自定义 JSON 文件覆盖
#  格式: [["问题", "关键词"], ...]
# ─────────────────────────────────────────────────────────────
SEED_QUESTIONS = [
    ("行业标准最新版本是什么", "行业标准最新版本"),
    ("如何评估供应商的技术能力", "供应商技术能力评估"),
    ("常见工艺流程有哪些关键控制点", "工艺流程关键控制点"),
    ("可靠性测试标准和方法有哪些", "可靠性测试方法"),
    ("如何降低生产成本同时保持质量", "生产成本质量控制"),
]
